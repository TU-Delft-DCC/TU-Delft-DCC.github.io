...
- [Yan Wang](https://www.tudelft.nl/en/library/research-data-management/r/support/data-stewardship/contact/yan-wang) - head of RDS 
- [Alastair Dunning](https://www.tudelft.nl/en/staff/a.c.dunning/?cHash=5931d1647f261a843cd28d0178a35fa6) - head of Research Services

## Open Science
[Open Science](https://www.tudelft.nl/open-science) is an important way to spread TU Delft’s mission to deliver Science to Society. With Open Science we wish to make scientific knowledge accessible, free of charge to all users and online. In this way new ideas spread faster and wider which in turn lead to new research. We support our researchers in doing all that is necessary to be part of Open Science. 
...
The Open Science Community Delft (OSCD) is the local community initiative to help out researchers, teachers, students, and support staff with working more openly, collaboratively, and FAIR-ly (Findable, Accessible, Interoperable and Reusable), through sharing our knowledge and participating in various learning opportunities. OSCD is part of the International Network of Open Science and Scholarship Communities [(INOSC)](https://osc-international.com/). 

### Links
- [Open Science community website](https://osc-delft.github.io/)
- Tanya Yankelevich - Community manager

## Open Hardware
The Open Hardware project aims to further embed open-source hardware into the Open Science movement at TU Delft. The project will accomplish this by supporting students and researchers in making their hardware projects open source and by delivering training activities and learning materials to further the community goals. The program was initiated by José Urra Llanusa (DCC RSE) and Santosh Ilamparuthi (Data steward EEMCS).
...
[Delft High Performance Computing Centre](https://www.tudelft.nl/dhpc) (DHPC) deploys the infrastructure (hardware, software and staff) for TU Delft that is capable of complex analysis and modelling for researchers. It manages [DelftBlue](https://www.tudelft.nl/dhpc/system), the supercomputer at TU Delft. It is designed to meet researchers increasing need for extensive computing power to solve complex problems in physics, mechanics and dynamics. The system is characterized by flexibility, speed and user-friendliness. In its final phase it will offer 20,000 CPU cores in over 400 compute nodes.

- [Delft Blue Team](https://www.tudelft.nl/dhpc/organisation/team)
- [Delft Blue documentation](https://doc.dhpc.tudelft.nl/delftblue/) - User documentation
...
- [4TU team](https://data.4tu.nl/info/over-4turesearchdata/contact) - All contacts
- [Alessandra Soro](https://community.data.4tu.nl/members/asoro/) -  Community manager
...
- [Public schedule Code Refinery TU Delft](https://www.tudelft.nl/en/library/research-data-management/r/training-events/training-for-researchers/coderefinery-workshops-good-practices-in-research-software-development)
- TU Delft Coordinator: [Paula Martinez Lavancy](https://www.tudelft.nl/library/research-data-management/r/support/data-stewardship/contact/paula-martinez-lavanchy)


## SURF
[SURF](https://www.surf.nl/en) is a cooperative association of Dutch educational and research institutions in which the members combine their strengths. Within SURF, they work together to acquire or develop the best possible digital services, and to encourage knowledge sharing through continuous innovation. SURF hosts the infrastucture of the Dutch supercomputers and offers compute and data services for (inter)national research and education.

- [SURF training](https://www.surf.nl/en/training-courses-for-research) - courses overview
- [SURF events](https://www.surf.nl/en/agenda/research-and-ict) - calendar of events


## NWO
The Dutch Research Council [(NWO)](https://www.nwo.nl/en) is one of the most important science funding bodies in the Netherlands and realises quality and innovation in science. Each year, NWO invests almost 1 billion euros in curiosity-driven research, research related to societal challenges and research infrastructure.
...
To support this, the [implementation plan](https://www.nwo.nl/en/news/setup-thematic-digital-competence-centers) from NWO provides for the formation of thematic DCCs [(TDCC)](https://tdcc.nl/). These network organisations will be established at the start of 2022 with funding from NWO. There will be three TDCC networks that will bring together researchers in three ‘domains’:
