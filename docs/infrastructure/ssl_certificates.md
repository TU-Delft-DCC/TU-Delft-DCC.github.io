...
2. Follow the [instructions on the HARICA website to create a SSL certificates](https://guides.harica.gr/docs/Guides/Server-Certificate/Request-for-Domain-Validated-DV/). You need to do so for the qualified domain name associated with your Server. E.g. `my-site.tudelft.nl`.
