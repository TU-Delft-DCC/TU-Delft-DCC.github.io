...
- Facilitate in **collaborative research** as others can easily join the project and understand its structure
:::
...
- **Script-based or Classic Tools**
  ...
  - Make – a traditional build automation tool still used in research for its simplicity
- **Code-Based Workflow Managers:** These systems are primarily driven by writing code in general-purpose languages (like Python or Scala), often using functions, decorators, or object-oriented patterns:
  - Snakemake (Python-based)
  - Nextflow (DSL based on Groovy)
  - Airflow (Python-based)
  - Ruffus, SciPipe, SCOOP, JUDI, Hyperloom, Balsam, Anduril, COMPS
- **DSL-Based Workflow Managers:** These tools define workflows using their own domain-specific languages, offering concise and human-readable syntax:
  - Snakemake
  - Nextflow
  - Airflow
  - ClusterFlow
