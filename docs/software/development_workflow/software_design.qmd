...
Software design is not just about writing code, it is about creating systems that **stand the test of time**. Good software design creates systems that enable reproducible science, foster collaboration, and remain usable and trustworthy for the long term. It provides a shared structure that allows researchers to build on each other’s work rather than starting from scratch.
...
Architecture in research software is not about building the biggest system, but about ensuring that scientific insight can grow without being constrained by the code.
:::
...
## The C4 Model for research software deign
